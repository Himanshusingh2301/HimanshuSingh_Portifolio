    ...
    return (
        <section id="about" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
            ...
            <div className="container mx-auto px-6 text-center relative z-10">
                ...
                <div className="relative w-32 h-32 md:w-70 md:h-70 mx-auto mb-8 mt-5 animate-fade-in">
                    ...
                    <img
                        ...
                        className="relative  w-full h-full object-cover rounded-full object-top border-2  border-white/10 shadow-2xl"
                    />
                </div>
                ...
                <div className="flex flex-col mb-25 sm:flex-row items-center justify-center gap-4 animate-slide-up" style={{ animationDelay: '0.4s' }}>
                    <Link
                        to="projects"
                        smooth={true}
                        offset={-100}
