                            ...
                            {job.certificate && (
                                job.certificate.startsWith('http') ? (
                                    ...
                                    <button
                                        ...
                                        className="relative flex items-center cursor-pointer gap-2 text-sm text-indigo-400 
             hover:text-indigo-300 transition-colors font-medium group"
                                    >
                                        <Award size={16} />
                                        <span className="relative">
                                            View Certificate
                                            <span
                                                className="absolute left-0 -bottom-0.5 h-px w-0 bg-indigo-400 
